...
<table role="presentation" style="margin:18px 0;width:100%;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:14px 16px;">
    ...
    <tr><td style="padding:3px 0;color:#475569;">Pay online</td><td style="padding:3px 0;text-align:right;color:#0f766e;font-weight:600;"><?= e(url('/patient/invoices')) ?></td></tr>
</table>
<p>Outstanding balances can be settled in cash at the cashier or online through your patient portal.</p>
<?php else: ?>
