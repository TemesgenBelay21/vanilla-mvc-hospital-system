...
-- ==============================================================
-- Phase 3 tables — billing, payments and in-app notifications.
-- A completed appointment, lab request, dispensed prescription or
-- discharged admission can be billed exactly once thanks to the
-- unique (source_type, source_id) key on invoice_items.
-- ==============================================================

-- ---------------------------------------------------------------
-- Invoices (one per visit / admission, itemized)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- Invoice line items (consultation, lab, medicine, ward charges)
-- ---------------------------------------------------------------
...
-- ---------------------------------------------------------------
-- Payments (cash offline or Telebirr online)
-- ---------------------------------------------------------------
